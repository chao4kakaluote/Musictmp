 ...
 */
public class MusicAdapter extends ArrayAdapter<com.example.administrator.music.db.Music>
{
    private int resourceId;
    public MusicAdapter(Context context, int ResourceId, List<com.example.administrator.music.db.Music> musicList)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        com.example.administrator.music.db.Music music=getItem(position);
        View view;
        ViewHolder holder;
        if(convertView==null)
        {
